"""
Django settings for app_rtrt_dev_56472 project.
...
ROOT_URLCONF = 'app_rtrt_dev_56472.urls'
...
WSGI_APPLICATION = 'app_rtrt_dev_56472.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_rtrt_dev_56472 API",
    "DESCRIPTION": "API documentation for app_rtrt_dev_56472 App",
    "VERSION": "v1",
}
